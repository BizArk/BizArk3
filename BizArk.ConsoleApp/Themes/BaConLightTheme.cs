...
namespace BizArk.ConsoleApp.Themes
{
	...
	public class BaConLightTheme : IBaConTheme
	{
		...
		/// </summary>
		public ConsoleColor? UsageColor { get; set; } = ConsoleColor.DarkYellow;

		/// <summary>
		/// Gets or sets the color used to display a required argument. A null will use the default console text color.
		/// </summary>
		public ConsoleColor? RequiredArgColor { get; set; } = ConsoleColor.Black;

		/// <summary>
		/// Gets or sets the color used to display a non-required argument. A null will use the default console text color.
		/// </summary>
		public ConsoleColor? StandardArgColor { get; set; } = ConsoleColor.DarkGray;

		/// <summary>
		/// Gets or sets the color used to display trace messages.
		/// </summary>
		public ConsoleColor? LogTraceColor { get; set; } = ConsoleColor.Gray;

		/// <summary>
		/// Gets or sets the color used to display debug messages.
		/// </summary>
		public ConsoleColor? LogDebugColor { get; set; } = ConsoleColor.DarkGray;

		/// <summary>
		/// Gets or sets the color used to display info messages.
		/// </summary>
		public ConsoleColor? LogInfoColor { get; set; } = ConsoleColor.Black;

		/// <summary>
		/// Gets or sets the color used to display warning messages.
		/// </summary>
		public ConsoleColor? LogWarnColor { get; set; } = ConsoleColor.DarkMagenta;

		/// <summary>
		/// Gets or sets the color used to display error messages.
		/// </summary>
		public ConsoleColor? LogErrorColor { get; set; } = ConsoleColor.Magenta;
